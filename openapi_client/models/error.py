...
class Error(object):
    ...
    def __init__(self, type='about:blank', title=None, status=None, detail=None, instance=None, correlation_id=None, local_vars_configuration=None):  # noqa: E501
    ...
    def status(self, status):
        ...
        if (self.local_vars_configuration.client_side_validation and
                status is not None and status > 999):  # noqa: E501
            raise ValueError("Invalid value for `status`, must be a value less than or equal to `999`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
    ...
    def correlation_id(self):
        ...
        A unique identifier for the request, used for NWS debugging purposes. Please include this identifier with any correspondence to help us investigate your issue.  # noqa: E501
